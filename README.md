...
An automated resume screening system that categorizes resumes using machine learning.

## Features

- Data preprocessing and cleaning
- Resume text analysis and visualization
- Machine learning model training
- Automated CV screening and categorization
